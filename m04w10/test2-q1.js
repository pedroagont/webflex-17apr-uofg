...
If the two values are explicitly equal to each other, return true
otherwise return false if either the values or not the same, or both objects do not have that key.
...
function keyMatcher(obj1, obj2, key) {
...
console.log(
  keyMatcher(
    { a: 1, b: 2, c: 3 },
    { here: 3, is: 2, a: 1, silly: 0, example: -1 },
    'a'
  )
...
console.log(
  keyMatcher(
    ...
    { apple: 'green', banana: 'brown', cherry: 'black' },
    'apple'
  )
